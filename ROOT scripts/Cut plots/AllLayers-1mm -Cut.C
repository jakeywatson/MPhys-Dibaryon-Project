...
TCanvas *Background = new TCanvas("Background", "Background", 100, 10, 1500, 800);

TCanvas *Signal = new TCanvas("Signal", "Signal", 100, 10, 1500, 800);

TCanvas *Test = new TCanvas("Test", "Test", 100, 10, 1500, 800);
Test->Divide(2);

//First file

//Create a filereader
TFile f1("photons-1M-1mm.root");
...
t1.Draw("Layer_1:Layer_2>>h1a", "Layer_1 > -1.64*Layer_2 + 18 && Layer_1 <50 && Layer_2<50 && Layer_1 >0 && Layer_2>0 && Layer_3==0 && Layer_4==0 && Layer_5==0");
...
t1.Draw("Layer_1:Layer_2>>h2a", " Layer_1 > 5*Layer_2 -20 && Layer_1 <50 && Layer_2<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0");
...
t1.Draw("Layer_1+Layer_2:Layer_3>>h3a", "Layer_1+Layer_2 >  -1.07*Layer_3 + 16 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0 ");
...
t1.Draw("Layer_2:Layer_3>>h4a", "Layer_2 > -0.9375*Layer_3 + 15 && Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0");
...
t1.Draw("Layer_1:Layer_2>>h5a", "Layer_1 < 4.33*Layer_2 - 13 && Layer_1 <50 && Layer_2<50 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5==0");
...
t1.Draw("Layer_2:Layer_3>>h6a", "Layer_3> 5 && Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_1>0 && Layer_4>0 && Layer_5==0");

Layer4->cd(3);

TH2F *h7a = new TH2F("h7a", "Layer_3:Layer_4", 100, 0, 50, 100, 0, 50);
h7a->SetMarkerColor(kRed);
t1.Draw("Layer_3:Layer_4>>h7a", "Layer_3 > -0.23*Layer_4 + 7 && Layer_3<50 && Layer_4<50 && Layer_4<50 &&Layer_3>0 && Layer_4>0 && Layer_1>0 && Layer_2>0 && Layer_5==0");

Layer4->cd(4);

TH2F *h8a = new TH2F("h8a", "Layer_1+Layer_2+Layer_3:Layer_4", 100, 0, 50, 100, 0, 50);
h8a->SetMarkerColor(kRed);
t1.Draw("Layer_1+Layer_2+Layer_3:Layer_4>>h8a", " Layer_1+Layer_2+Layer_3 > -1.5*Layer_4 + 24 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5==0");
...
t1.Draw("Layer_1:Layer_2>>h9a", "Layer_1 > -0.625*Layer_2 + 5 && Layer_1 <50 && Layer_2<50 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");
...
t1.Draw("Layer_2:Layer_3>>h10a", "Layer_2 > -0.67*Layer_3 + 6 && Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_1>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Layer5->cd(3);

TH2F *h11a = new TH2F("h11a", "Layer_3:Layer_4", 100, 0, 50, 100, 0, 50);
h11a->SetMarkerColor(kRed);
t1.Draw("Layer_3:Layer_4>>h11a", "Layer_3 > -0.375*Layer_4 + 6 && Layer_3<50 && Layer_4<50 && Layer_4<50 &&Layer_3>0 && Layer_4>0 && Layer_1>0 && Layer_2>0 && Layer_5>0 && Layer_6==0");
...
t1.Draw("Layer_4:Layer_5>>h12a", "Layer_4 > -0.26*Layer_5 + 9 && Layer_4<50 && Layer_5<50 && Layer_4>0 && Layer_5>0 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Combos->cd(1);

TH2F *h13a = new TH2F("h13a", "Layer_1+Layer_2:Layer_3", 100, 0, 50, 100, 0, 50);
h13a->SetMarkerColor(kRed);
t1.Draw("Layer_1+Layer_2:Layer_3>>h13a", "Layer_1+Layer_2 > -0.83*Layer_3 + 10 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0 ");

Combos->cd(2);

TH2F *h14a = new TH2F("h14a", "Layer_1+Layer_2+Layer_3:Layer_4", 100, 0, 50, 100, 0, 50);
h14a->SetMarkerColor(kRed);
t1.Draw("Layer_1+Layer_2+Layer_3:Layer_4>>h14a", "Layer_1+Layer_2+Layer_3 >  -0.84*Layer_4 + 16 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Combos->cd(3);

TH2F *h15a = new TH2F("h15a", "Layer_1:Layer_2+Layer_3+Layer_4+Layer_5", 100, 0, 50, 100, 0, 50);
h15a->SetMarkerColor(kRed);
t1.Draw("Layer_1+Layer_2+Layer_3+Layer_4:Layer_5>>h15a", "Layer_1+Layer_2+Layer_3+Layer_4 > -0.33*Layer_5 + 20 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_5<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");
...
t2.Draw("Layer_1:Layer_2>>h1b", "Layer_1 > -1.64*Layer_2 + 18 && Layer_1<50 && Layer_2<50 &&  Layer_1 >0 && Layer_2>0 && Layer_3==0 && Layer_4==0 && Layer_5==0 ");
...
t2.Draw("Layer_1:Layer_2>>h2b", "Layer_1 < 5*Layer_2 -20 && Layer_1<50 && Layer_2<50 &&  Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0 ");
...
t2.Draw("Layer_1+Layer_2:Layer_3>>h3b", "Layer_1+Layer_2 >  -1.07*Layer_3 + 16 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0");
...
t2.Draw("Layer_2:Layer_3>>h4b", "Layer_2 > -0.9375*Layer_3 + 15 && Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0");
...
t2.Draw("Layer_1:Layer_2>>h5b", "Layer_1 < 4.33*Layer_2 - 13 && Layer_1<50 && Layer_2<50 &&  Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5==0 ");
...
t2.Draw("Layer_2:Layer_3>>h6b", " Layer_3 > 5&& Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_1>0 && Layer_4>0 && Layer_5==0");
...
t2.Draw("Layer_3:Layer_4>>h7b", "Layer_3 > -0.23*Layer_4 + 7 && Layer_3<50 && Layer_4<50&& Layer_3>0 && Layer_4>0 && Layer_1>0 && Layer_2>0 && Layer_5==0");

Layer4->cd(4);

TH2F *h8b = new TH2F("h8b", "Layer_1+Layer_2+Layer_3:Layer_4", 100, 0, 50, 100, 0, 50);
h8b->SetMarkerColor(kBlue);
t2.Draw("Layer_1+Layer_2+Layer_3:Layer_4>>h8b", "Layer_1+Layer_2+Layer_3 > -1.5*Layer_4 + 24 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5==0");
...
t2.Draw("Layer_1:Layer_2>>h9b", "Layer_1 > -0.625*Layer_2 + 5 && Layer_1<50 && Layer_2<50 &&  Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0 ");
...
t2.Draw("Layer_2:Layer_3>>h10b", "Layer_2 > -0.67*Layer_3 + 6 && Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_1>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");
...
t2.Draw("Layer_3:Layer_4>>h11b", "Layer_3 > -0.375*Layer_4 + 6 && Layer_3<50 && Layer_4<50&& Layer_3>0 && Layer_4>0 && Layer_1>0 && Layer_2>0 && Layer_5>0 && Layer_6==0");
...
t2.Draw("Layer_4:Layer_5>>h12b", "Layer_4 > -0.26*Layer_5 + 9 && Layer_4<50 && Layer_5<50 && Layer_4>0 && Layer_5>0 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Combos->cd(1);

TH2F *h13b = new TH2F("h13b", "Layer_1+Layer_2:Layer_3", 100, 0, 50, 100, 0, 50);
h13b->SetMarkerColor(kBlue);
t2.Draw("Layer_1+Layer_2:Layer_3>>h13b", "Layer_1+Layer_2 > -0.83*Layer_3 + 10 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Combos->cd(2);

TH2F *h14b = new TH2F("h14b", "Layer_1+Layer_2+Layer_3:Layer_4", 100, 0, 50, 100, 0, 50);
h14b->SetMarkerColor(kBlue);
t2.Draw("Layer_1+Layer_2+Layer_3:Layer_4>>h14b", "Layer_1+Layer_2+Layer_3 >  -0.84*Layer_4 + 16 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Combos->cd(3);

TH2F *h15b = new TH2F("h15b", "Layer_1+Layer_2+Layer_3+Layer_4:Layer_5", 100, 0, 50, 100, 0, 50);
h15b->SetMarkerColor(kBlue);
t2.Draw("Layer_1+Layer_2+Layer_3+Layer_4:Layer_5>>h15b", "Layer_1+Layer_2+Layer_3+Layer_4 > -0.33*Layer_5 + 20 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_5<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");
...
//Create a filereader
TFile f3("deuterons-1M-1mm.root");
...
t3.Draw("Layer_1:Layer_2>>h1c", "Layer_1 > -1.64*Layer_2 + 18 && Layer_1<50 && Layer_2<50 && Layer_1 >0 && Layer_2>0 && Layer_3==0 && Layer_4==0 && Layer_5==0 ");
...
t3.Draw("Layer_1:Layer_2>>h2c", " Layer_1 < 5*Layer_2 -20 && Layer_1<50 && Layer_2<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0 ");
...
t3.Draw("Layer_1+Layer_2:Layer_3>>h3c", " Layer_1+Layer_2 >  -1.07*Layer_3 + 16 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0");
...
t3.Draw("Layer_2:Layer_3>>h4c", "Layer_2 >  -0.9375*Layer_3 + 15 && Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_4==0 && Layer_5==0");
...
t3.Draw("Layer_1:Layer_2>>h5c", "Layer_1 < 4.33*Layer_2 - 13 && Layer_1<50 && Layer_2<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5==0 ");
...
t3.Draw("Layer_2:Layer_3>>h6c", "Layer_3 > 5 && Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_1>0 && Layer_4>0 && Layer_5==0");
...
t3.Draw("Layer_3:Layer_4>>h7c", "Layer_3 > -0.23*Layer_4 + 7 &&  Layer_3<50 && Layer_4<50 && Layer_3>0 && Layer_4>0 && Layer_1>0 && Layer_2>0 && Layer_5==0");

Layer4->cd(4);

TH2F *h8c = new TH2F("h8c", "Layer_1+Layer_2+Layer_3:Layer_4", 100, 0, 50, 100, 0, 50);
h8c->SetMarkerColor(kGreen);
t3.Draw("Layer_1+Layer_2+Layer_3:Layer_4>>h8c", "Layer_1+Layer_2+Layer_3 > -1.5*Layer_4 + 24 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5==0");
...
t3.Draw("Layer_1:Layer_2>>h9c", "Layer_1 > -0.625*Layer_2 + 5 && Layer_1<50 && Layer_2<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");
...
t3.Draw("Layer_2:Layer_3>>h10c", "Layer_2 > -0.67*Layer_3 + 6 && Layer_2<50 && Layer_3<50 && Layer_2>0 && Layer_3>0 && Layer_1>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");
...
t3.Draw("Layer_3:Layer_4>>h11c", " Layer_3 > -0.375*Layer_4 + 6 && Layer_3<50 && Layer_4<50 && Layer_3>0 && Layer_4>0 && Layer_1>0 && Layer_2>0 && Layer_5>0 && Layer_6==0");
...
t3.Draw("Layer_4:Layer_5>>h12c", " Layer_4 > -0.26*Layer_5 + 9 && Layer_4<50 && Layer_5<50 && Layer_4>0 && Layer_5>0 && Layer_1>0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Combos->cd(1);

TH2F *h13c = new TH2F("h13c", "Layer_1+Layer_2:Layer_3", 100, 0, 50, 100, 0, 50);
h13c->SetMarkerColor(kGreen);
t3.Draw("Layer_1+Layer_2:Layer_3>>h13c", " Layer_1+Layer_2 > -0.83*Layer_3 + 10 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Combos->cd(2);

TH2F *h14c = new TH2F("h14c", "Layer_1+Layer_2+Layer_3:Layer_4", 100, 0, 50, 100, 0, 50);
h14c->SetMarkerColor(kGreen);
t3.Draw("Layer_1+Layer_2+Layer_3:Layer_4>>h14c", "Layer_1+Layer_2+Layer_3 >  -0.84*Layer_4 + 16 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");

Combos->cd(3);

TH2F *h15c = new TH2F("h15c", "Layer_1+Layer_2+Layer_3+Layer_4:Layer_5", 100, 0, 50, 100, 0, 50);
h15c->SetMarkerColor(kGreen);
t3.Draw("Layer_1+Layer_2+Layer_3+Layer_4:Layer_5>>h15c", "Layer_1+Layer_2+Layer_3+Layer_4 > -0.33*Layer_5 + 20 && Layer_1<50 && Layer_2<50 && Layer_3<50 && Layer_4<50 && Layer_5<50 && Layer_1 >0 && Layer_2>0 && Layer_3>0 && Layer_4>0 && Layer_5>0 && Layer_6==0");
...
TH1F *BackgroundPhotons = new TH1F("BackgroundPhotons", "BackgroundPhotons", 100, 0, 190);

t1.Draw("Incident_Energy>>+BackgroundPhotons", "Layer_1 > -0.625*Layer_2 + 5 && Layer_2 > -0.67*Layer_3 + 6 && Layer_3 > -0.375*Layer_4 + 6 && Layer_4 > -0.26*Layer_5 + 9 && Layer_1 + Layer_2 > -0.83*Layer_3 + 10 && Layer_1 + Layer_2 + Layer_3 >  -0.84*Layer_4 + 16 && Layer_1 + Layer_2 + Layer_3 + Layer_4 > -0.33*Layer_5 + 20 && (Layer_1+Layer_2+Layer_3+Layer_4+Layer_5>0)");

BackgroundPhotons->Draw("");

Test->cd(2);

TH1F *BackgroundProtons = new TH1F("BackgroundProtons", "BackgroundProtons", 100, 0, 190);

t2.Draw("Incident_Energy>>+BackgroundProtons", "Layer_1 > -0.625*Layer_2 + 5 && Layer_2 > -0.67*Layer_3 + 6 && Layer_3 > -0.375*Layer_4 + 6 && Layer_4 > -0.26*Layer_5 + 9 && Layer_1 + Layer_2 > -0.83*Layer_3 + 10 && Layer_1 + Layer_2 + Layer_3 >  -0.84*Layer_4 + 16 && Layer_1 + Layer_2 + Layer_3 + Layer_4 > -0.33*Layer_5 + 20 && (Layer_1+Layer_2+Layer_3+Layer_4+Layer_5>0)");

BackgroundProtons->Draw("");

double photon_background = BackgroundPhotons->Integral()*1000.0;
double proton_background = BackgroundProtons->Integral()*100.0;
double total_background = photon_background + proton_background;

cout << "photon count: " << photon_background << endl;
cout << "proton count: " << proton_background << endl;

Background->cd();

TH1F *BackgroundHist = new TH1F("BackgroundHist", "BackgroundHist", 100, 0, 190);

t1.Draw("Incident_Energy>>+BackgroundHist", "Layer_1 > -0.625*Layer_2 + 5 && Layer_2 > -0.67*Layer_3 + 6 && Layer_3 > -0.375*Layer_4 + 6 && Layer_4 > -0.26*Layer_5 + 9 && Layer_1 + Layer_2 > -0.83*Layer_3 + 10 && Layer_1 + Layer_2 + Layer_3 >  -0.84*Layer_4 + 16 && Layer_1 + Layer_2 + Layer_3 + Layer_4 > -0.33*Layer_5 + 20 && (Layer_1+Layer_2+Layer_3+Layer_4+Layer_5>0)");
t2.Draw("Incident_Energy>>+BackgroundHist", "Layer_1 > -0.625*Layer_2 + 5 && Layer_2 > -0.67*Layer_3 + 6 && Layer_3 > -0.375*Layer_4 + 6 && Layer_4 > -0.26*Layer_5 + 9 && Layer_1 + Layer_2 > -0.83*Layer_3 + 10 && Layer_1 + Layer_2 + Layer_3 >  -0.84*Layer_4 + 16 && Layer_1 + Layer_2 + Layer_3 + Layer_4 > -0.33*Layer_5 + 20 && (Layer_1+Layer_2+Layer_3+Layer_4+Layer_5>0)");


BackgroundHist->GetYaxis()->SetTitle("Background Count");
BackgroundHist->GetXaxis()->SetTitle("Incident Energy");
BackgroundHist->SetTitle("Background Count against Incident Energy");

BackgroundHist->Draw("");
Background->SaveAs("Background Contamination v Incident Energy.gif");

Signal->cd();

TH1F *SignalHist = new TH1F("SignalHist", "SignalHist", 100, 0, 190);

t3.Draw("Incident_Energy>>+SignalHist", "Layer_1 > -0.625*Layer_2 + 5 && Layer_2 > -0.67*Layer_3 + 6 && Layer_3 > -0.375*Layer_4 + 6 && Layer_4 > -0.26*Layer_5 + 9 && Layer_1 + Layer_2 > -0.83*Layer_3 + 10 && Layer_1 + Layer_2 + Layer_3 >  -0.84*Layer_4 + 16 && Layer_1 + Layer_2 + Layer_3 + Layer_4 > -0.33*Layer_5 + 20 && (Layer_1+Layer_2+Layer_3+Layer_4+Layer_5>0)");

double signal_count = SignalHist->Integral();
cout << "signal count: " << signal_count << endl;

SignalHist->GetYaxis()->SetTitle("Deuteron Count");
SignalHist->GetXaxis()->SetTitle("Incident Energy");
SignalHist->SetTitle("Signal Count against Incident Energy");

SignalHist->Draw("");
Signal->SaveAs("Signal Count v Incident Energy.gif");
...
Layer2->SaveAs("StopsL2-Cut.gif");

Layer3->cd();
Layer3->cd(1);

h2a->GetYaxis()->SetTitle("Layer_1");
h2a->GetXaxis()->SetTitle("Layer_2");
h2a->SetTitle("Energy Deposited Layer_1:Layer_2");
...
h3a->GetYaxis()->SetTitle("Layer_1+Layer_2");
h3a->GetXaxis()->SetTitle("Layer_3");
h3a->SetTitle("Energy Deposited Layer_1+Layer_2:Layer_3");
...
h4a->GetYaxis()->SetTitle("Layer_2");
h4a->GetXaxis()->SetTitle("Layer_3");
h4a->SetTitle("Energy Deposited Layer_2:Layer_3");

h4a->Draw("");
h4b->Draw("same");
h4c->Draw("same");

Layer3->SaveAs("StopsL3-Cut.gif");
...
Combos->SaveAs("L5Combos-Cut.gif");
...
NostopCombo->SaveAs("NostopCombos-Cut.gif");
}